...
Install the Obsidian Git plugin in your vault:

1. Settings → Community plugins → Browse → "Obsidian Git"
2. Enable the plugin
3. Configure auto-commit and auto-push

Your blog repository is at `~/Documents/EDI/blog/`, so you can write posts in Obsidian and they'll automatically sync to GitHub.
